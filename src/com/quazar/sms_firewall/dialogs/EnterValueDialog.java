...
public class EnterValueDialog extends Dialog {
	...
	public EnterValueDialog(Context context, String title,
			SelectListener<String> listener) {
		...
		((Button) v.findViewById(R.id.ok_btn))
				.setOnClickListener(new Button.OnClickListener() {
					@Override
					public void onClick(View v) {
						String value = ((EditText) findViewById(R.id.value_fileld))
								.getText().toString();
						if (value == null || value.equals("")) {
							Toast.makeText(
									getContext(),
									getContext().getResources().getString(
											R.string.enter_value_warning),
