...
public class MessageExampleDialog extends AlertDialog{	
	public MessageExampleDialog(final Context context, TopItem item){
		super(context);		
		...
		messagesLisn.setAdapter(new ArrayAdapter<String>(context, R.layout.examples_list_item, R.id.example_message, item.getExamples()));
